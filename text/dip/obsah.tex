...
\begin{figure}[hbt]
    ...
    \subfigure[Ruleta podle fitness]{
        \label{obrSelekceR1}
        \centering
            \includegraphics[width=0.27\textwidth]{fig/ruleta1.pdf}
    }
    \hfill
    \subfigure[Ruleta podle pořadí]{
        \label{obrSelekceR2}
        \centering
            \includegraphics[width=0.27\textwidth]{fig/ruleta2.pdf}
    }
    \hfill
    \subfigure[Turnaj]{
        \label{obrSelekceT}
        \centering
            \includegraphics[width=0.27\textwidth]{fig/turnaj.pdf}
    }
...
\begin{figure}[htb]
    ...
    \subfigure[Jednobodové]{
        \centering
            \includegraphics[width=0.24\textwidth]{fig/crossover1.pdf}
    }
    \hskip1cm
    \subfigure[Vícebodové]{
        \centering
            \includegraphics[width=0.24\textwidth]{fig/crossover2.pdf}
        }
    \hskip1cm
    \subfigure[Uniformní]{
        \centering
            \includegraphics[width=0.24\textwidth]{fig/crossoverU.pdf}
        }
...
\begin{figure}[htb]
    \centering\includegraphics[width=0.66\textwidth]{fig/filter2.pdf}
...
\begin{figure}[htb]
    ...
    \subfigure[Výstup Sobelova detektoru]{
        \hskip0.75cm
        \includegraphics[width=0.21\textwidth]{fig/cameraman_256_sobel.png}
        \hskip0.75cm
        \label{obrSobelOut}
    }
    \subfigure[Výstup Cannyho detektoru]{
        \hskip0.75cm
...
\todo{systém události + handlery}
\todo{defaultní handlery}
\todo{sbírané statistiky}
\todo{výpis programů, ascii art}
\todo{teoretický handler pro gui}
...
\section{\todo{Nástroje pro práci s výsledky}}
