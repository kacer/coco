...
Toto pořadí platí v~celém průběhu evoluce. Pokud se použije počáteční velikost prediktorů 50\,\%, celkový počet úprav je nižší, v~průměru jich bylo 600,3. Pořadí pravidel je stejné, s~výjimkou prvních 10 tisíc generací, kdy se nejvíce používají koeficienty $c_{+2}$ a $c_{+1}$.
...
V~histogramu u~50\,\% šumu je rozdíl mezi nejsvětlejšími a nejtmavšími body výraznější. Prediktory tady nevybírají devítiokolí tolik rovnoměrně jako u~nižší intenzity šumu. Nejméně používané devítiokolí se vyskytovalo v~aktivním prediktoru jen 2~686 generací CGP, zatímco nejvíce používané celkem 123~739 generací, tedy přibližně 46krát více. %Rozdíl oproti 15\% šumu je pravděpodobně způsobený tím, že zde je poškozený každý druhý pixel a jednotlivé prediktory se od sebe liší méně.
...
\begin{figure}[p]
    ...
    \subfigure[15\% šum typu sůl a pepř]{
        % 137030, 358005
        \includegraphics[width=0.28\textwidth]{fig/predhist/sp15.png}
        \hskip2cm
        \includegraphics[width=0.28\textwidth]{fig/predhist/15.png}
    }

    \vskip0.5\baselineskip
    \subfigure[Obrázek částečně poškozený 25\% šumem typu sůl a pepř]{
        \includegraphics[width=0.28\textwidth]{fig/predhist/sp25part.png}
        \hskip2cm
        \includegraphics[width=0.28\textwidth]{fig/predhist/25part.png}
    }

    \vskip0.5\baselineskip
    \subfigure[50\% šum typu sůl a pepř]{
        % 123 739, 2 686
        \includegraphics[width=0.28\textwidth]{fig/predhist/sp50.png}
        \hskip2cm
        \includegraphics[width=0.28\textwidth]{fig/predhist/50.png}
    }

    \vskip0.5\baselineskip
    \subfigure[Detektor hran]{
        \includegraphics[width=0.28\textwidth]{fig/testimages/cameraman.png}
        \hskip2cm
        \includegraphics[width=0.28\textwidth]{fig/predhist/sobel.png}
    }
...
\begin{figure}[hbt]
    ...
    \subfigure[Poškozený obrázek]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sp25/noisy}
    }
    \hfill
    \subfigure[Mediánový filtr]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sp25/median}
    }
    \hfill
    \subfigure[Evolvovaný filtr]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sp25/evo}
    }
    \subfigure[Zapojení evolvovaného filtru]{
        \includegraphics[width=\textwidth]{fig/filters/sp25/filter}
    }
...
\begin{figure}[htb]
    \centering
    \subfigure[Poškozený obrázek]{
        \includegraphics[width=0.27\textwidth]{fig/filters/impulse10/noisy}
    }
    \hfill
    \subfigure[Mediánový filtr]{
        \includegraphics[width=0.27\textwidth]{fig/filters/impulse10/median}
    }
    \hfill
    \subfigure[Evolvovaný filtr]{
        \includegraphics[width=0.27\textwidth]{fig/filters/impulse10/evo}
    }
    \subfigure[Zapojení evolvovaného filtru]{
        \includegraphics[width=\textwidth]{fig/filters/impulse10/filter}
    }
...
\begin{figure}[htb]
    \centering
    \subfigure[Vstupní obrázek]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sobel/source}
    }
    \hfill
    \subfigure[Sobelův detektor]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sobel/sobel}
    }
    \hfill
    \subfigure[Evolvovaný detektor]{
        \includegraphics[width=0.27\textwidth]{fig/filters/sobel/evo}
    }
    \subfigure[Zapojení evolvovaného detektoru]{
        \includegraphics[width=\textwidth]{fig/filters/sobel/filter}
    }
