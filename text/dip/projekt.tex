...
\acknowledgment{Rád bych poděkoval Ing. Michaele Šikulové za cenné rady, zajímavé nápady, podnětné konzultace a odbornou pomoc při řešení této práce.

\vskip\baselineskip
\noindent{}Dále bych rád poděkoval Ing. Radku Hrbáčkovi, který mnou připravené výpočty spouštěl na superpočítači Anselm.
