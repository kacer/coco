...
\acknowledgment{Děkuji Ing. Michaele Šikulové nejen za cenné rady, náměty a nápady, ale především za její trpělivost a za veškerý čas, který mi věnovala v~souvislosti s~řešením této diplomové práce.
...
\vskip\baselineskip
\noindent{}Dále děkuji Ing. Radku Hrbáčkovi, který mnou připravené výpočty spouštěl na superpočítači Anselm.
